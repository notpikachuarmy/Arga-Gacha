...
export interface CharacterData { id:string; name:string; worldId:string; bannerId:string; classId:ClassId; rarity:number; lore:string; portrait:string; sprite:string; stats:Stats; provisionalClass?:boolean; }
